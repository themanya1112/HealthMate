...
class AdminPage extends StatelessWidget {
  ...
  void _onQRViewCreated(BuildContext context, QRViewController controller) {
    controller.scannedDataStream.listen((scanData) {
      ...
      String date = qrDataParts[2];
      String time = qrDataParts[1];
      String doctor_id = qrDataParts[3];

      _showPopup(context, userId, date, time,doctor_id);
    });
  }

  void _showPopup(BuildContext context, String userId, String date, String time,String doctor_id) {
    showDialog(
      context: context,
